 ...
 *
 */
class ConsoleErrorListener extends ErrorListener$1 {
    constructor() {
        super();
    }
...
class ProxyErrorListener extends ErrorListener$1 {
...
var error = {
    ...
    DiagnosticErrorListener, BailErrorStrategy, DefaultErrorStrategy, ErrorListener: ErrorListener$1
};
...
class HTMLLexer extends antlr4.Lexer {

    static grammarFileName = "HTMLLexer.g4";
    static channelNames = [ "DEFAULT_TOKEN_CHANNEL", "HIDDEN" ];
	static modeNames = [ "DEFAULT_MODE", "TAG", "SCRIPT", "STYLE", "ATTVALUE" ];
	...
	static symbolicNames = [ null, "HTML_COMMENT", "HTML_CONDITIONAL_COMMENT", 
                          ...
                          "ATTRIBUTE" ];
	static ruleNames = [ "HTML_COMMENT", "HTML_CONDITIONAL_COMMENT", "XML", 
                      ...
                      "STYLE_BODY", "STYLE_SHORT_BODY", "ATTVALUE_VALUE", 
                      "ATTRIBUTE", "ATTCHARS", "ATTCHAR", "HEXCHARS", "DECCHARS", 
...
HTMLLexer.CDATA = 4;
HTMLLexer.DTD = 5;
HTMLLexer.SCRIPTLET = 6;
HTMLLexer.SEA_WS = 7;
HTMLLexer.SCRIPT_OPEN = 8;
HTMLLexer.STYLE_OPEN = 9;
HTMLLexer.TAG_OPEN = 10;
HTMLLexer.HTML_TEXT = 11;
HTMLLexer.TAG_CLOSE = 12;
HTMLLexer.TAG_SLASH_CLOSE = 13;
HTMLLexer.TAG_SLASH = 14;
HTMLLexer.TAG_EQUALS = 15;
HTMLLexer.TAG_NAME = 16;
HTMLLexer.TAG_WHITESPACE = 17;
HTMLLexer.SCRIPT_BODY = 18;
HTMLLexer.SCRIPT_SHORT_BODY = 19;
HTMLLexer.STYLE_BODY = 20;
HTMLLexer.STYLE_SHORT_BODY = 21;
HTMLLexer.ATTVALUE_VALUE = 22;
HTMLLexer.ATTRIBUTE = 23;

HTMLLexer.TAG = 1;
HTMLLexer.SCRIPT = 2;
HTMLLexer.STYLE = 3;
HTMLLexer.ATTVALUE = 4;
...
class HTMLParserVisitor extends antlr4.tree.ParseTreeVisitor {
...
class HTMLParser extends antlr4.Parser {
...
function transform (input, visitor, errListener) {
...
class Visitor extends HTMLParserVisitor {}
